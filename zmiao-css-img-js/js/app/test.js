...
define("test",['jquery'], function($){
    var testObj={
        ...
        //验证密码 数字字母不能包含特殊字符
        psd:function(password) {//必须为字母加数字且长度不小于8位
        	   var str = password;
